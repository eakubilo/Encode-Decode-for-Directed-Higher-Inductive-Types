...
\newcommand{\ho}[3][2]{\mathsf{hom}_{#1}(#2,#3)}
...
%%% Map on paths %%%
\newcommand{\mapfunc}[1]{\ensuremath{\mathsf{aphom}_{#1}}\xspace} % Without argument
\newcommand{\map}[2]{\ensuremath{{#1}\mathopen{}\left({#2}\right)\mathclose{}}\xspace}
\let\Ap\map
%\newcommand{\Ap}[2]{\ensuremath{{#1}\left({#2}\right)}\xspace}
\newcommand{\mapdepfunc}[1]{\ensuremath{\mathsf{apdhom}_{#1}}\xspace} % Without argument

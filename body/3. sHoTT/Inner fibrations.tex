...
\begin{proof}
    ...
    \end{equation*}
    by lemma~\ref{rem:sumoverfistt}. We then proceed by applying \todo{define the extension type theorems so I can refer to the label here} which allows us to swap the order of the nested extension types:
    \begin{equation}
